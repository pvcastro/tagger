...
SCRIPT=./train.py
DATASET=./dataset/
TRAINING_SET=categories_harem_full
                ...
                do
                    ...
                    do
                        ...
                        do
                            ...
                            ~/anaconda2/bin/python $SCRIPT --train $DATASET$TRAINING_SET.txt --test $DATASET$TEST_SET.txt --tag_scheme=$tag_scheme --epochs=100 --all_emb=1 --pre_emb=embeddings/$embedding.txt --cap_dim=$cap_dim --lower=$lower --char_lstm_dim=$char_lstm_dim --word_lstm_dim=$word_lstm_dim --lr_method=sgd-lr_.005 > $RESULTS_FOLDER$OUTPUT
