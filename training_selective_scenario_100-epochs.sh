                ...
                do
                    ...
                    do
                        ...
                        do
	                        ...
	                        OUTPUT=final/selective/resultado_100-epochs_$TRAINING_SET\_$tag_scheme\_$embedding\_cap_dim-$cap_dim\_lower-$lower\_char_lstm_dim-$char_lstm_dim\_word_lstm_dim-$word_lstm_dim\_$i.txt
