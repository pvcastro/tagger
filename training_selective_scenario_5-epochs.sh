...
declare -a embeddings=("fasttext_s100" "wang2vec_s100" "glove_s100" "word2vec_s100")
                ...
                do
                    ...
                    do
                        ...
                        do
                            ...
                            ~/anaconda2/bin/python $SCRIPT --train $DATASET$TRAINING_SET.txt --test $DATASET$TEST_SET.txt --tag_scheme=$tag_scheme --epochs=5 --all_emb=1 --pre_emb=embeddings/$embedding.txt --cap_dim=$cap_dim --lower=$cap_dim --char_lstm_dim=$char_lstm_dim --word_lstm_dim=$word_lstm_dim > $RESULTS_FOLDER$OUTPUT
